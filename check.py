...
#     "Rvc_n": 0.15,    # Nominal vena cava flow resistance # edited (changed to 0.0025 from xxx for better left atrial pressures, changed back to 0.025)
...
#     "Vu_lv": 25,       # Left ventricular unstressed volume # adjusted to the shi paper
#     "Vu_ra": 4,           # Right atrial unstressed volume # adjusted to the shi paper
#     "Vu_rv": 30,       # Right ventricular unstressed volume # adjusted to the shi paper
# # }
#
#     # Table 6. Muscle Pump
# # muscle_pump = {
...
#     "Emax_lv0": 1.392,   # Basal level of maximum end-systolic elastance of the left ventricle
#     "Emax_rv0": 2.412,   # Basal level of maximum end-systolic elastance of the right ventricle
...
#     "K2": 25,            # Parameter for CO2 dissociation equation (mmHg)
...
#     "R_pv": 0.1,         # Pulmonary venous flow resistance # edited to remove the backflow
#     "Vu_pa": 1,            # Pulmonary arterial unstressed volume # edited for dgsm
#     "Vu_pp": 116.6775,     # Pulmonary peripheral unstressed volume
...
#     "P_abdmin_n": -2.5,     # Basal value of abdominal pressure at the end of inspiration
#     "P_thormax_n": -3,      # Basal value of intrathoracic pressure at the end of expiration
#     "P_thormin_n": -3,      # Basal value of intrathoracic pressure at the end of inspiration
