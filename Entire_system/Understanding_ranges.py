...
X_500 = np.load('All_params_DGSM_500_X_samples_HR_P_sys_P_dia_exercise.npy')[:97227, :]
Result_500 = np.load('Results_DGSM_351_exercise_all_params.npy')[:,0]
...
# exercise no delay or volume params
# sp = ProblemSpec({
#     'outputs': ["HR"],
#
#     'names': [
