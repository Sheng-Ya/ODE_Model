...
if __name__ == "__main__":
    ...
    sp = ProblemSpec({
        ...
        'bounds': [
            ...
            [0.0421 * lower, 0.0421 * upper], [21.0379 * lower, 21.0379 * upper],
    ...
    X = lhd.sample(100000)
    np.save('New_LHCS_100000_X_sample_HR_P_sys_P_dia_exercise.npy', X)
    ...
    np.save('New_LHCS_100000_Result_HR_P_sys_P_dia_exercise.npy', Result)
