...
X = np.load('DGSM_500_X_samples_rest_20_no_Pthor_Vtot.npy')[:57000,:]
Result = np.load('Result_DGSM_rest_no_pthor_vtot_1_200.npy')[:57000,:]

# X2 = np.load('DGSM_500_X_samples_rest_20_no_Pthor_Vtot.npy')[57200:126170,:]
# Result2 = np.load('Result_DGSM_delay_new_no_pthor_no_vtot.npy')
#
