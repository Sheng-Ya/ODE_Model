...
RAW_OUTPUT_NAMES_PER_STATE = [
    ...
    "Pericardial_Volume_Percentage_Change", "Pericardial_Pressure"
]
...
RAW_OUTPUT_COLUMNS_TO_DROP = [11, 14, 17, 20, 27, 30, 43, 46, 49, 52, 59, 62]
    ...
    def simulate(self, x: TensorLike) -> tuple[TensorLike, TensorLike]:
        ...
        if y.shape[1] != expected_raw_outputs:
            raise ValueError(
                ...
                f"{expected_raw_outputs} raw columns before dropping to 50 targets."
            )
