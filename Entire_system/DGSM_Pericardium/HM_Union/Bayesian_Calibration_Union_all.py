...
Overlap = {
    'ahead1', 'C2', 'C_O2_param1', 'C_O2_param2', 'C_sv', 'Emax_lv0', 'Emax_ra', 'Emax_rv0', 'fes_o', 'fev_o', 'GT_v',
    'KE_la', 'KE_lv', 'KE_ra', 'KE_rv', 'l', 'P0_la', 'P0_lv', 'P0_rv', 'PaCO2_n', 'PAMO2_nominal', 'r', 'R_po', 'R_sa',
    'R_tr', 'rise_time_ven', 's', 'scale_param1', 'scale_param4', 'T0', 'theta_po_max', 'theta_tr_max', 'V0_dead',
    'V_nominal', 'V_scale', 'Vu_ev0', 'Vu_jp', 'Vu_la', 'Vu_lv', 'Vu_rv', 'Vu_sv0'
}

# Only in Rest
Rest_only = {
    'a2', 'Emax_la', 'f_ab_max', 'fab_o', 'fes_inf', 'fes_min', 'fev_inf', 'Io_sv', 'K2', 'kcc_sv',
    'kes', 'MO2_bp', 'P_n', 'R_pp', 'R_rs', 'rise_time_atr', 'Vu_ra', 'Wb_sh'
}

# Only in Exercise
Exercise_only = {
    'C_pv', 'Cvb_O2_n', 'E_rs', 'G_ap', 'GEmax_lv', 'GEmax_rv', 'GR_amp', 'GT_s', 'GV_sv', 'KcCO2', 'P_n_max',
    'phi_max', 'Rvc_n', 'VA_rest', 'Wp_v', 'Yv_max'
}
...
"Rest PaCO2": (35.5, 24.01), "Rest Pericardial Pressure": (1.5, 2.25),
...
"Exercise PaCO2": (38.4, 6.76), "Exercise Pericardial Pressure": (5.5, 2.25)
}
