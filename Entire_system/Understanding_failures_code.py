...
if __name__ == "__main__":
    ...
    sp = ProblemSpec({
        ...
        'bounds': [
            ...
            [0.05 * lower, 0.05 * upper], [0.15 * lower, 0.15 * upper], [0.3 * lower, 0.3 * upper], [0.9 * 0.95, 0.9 * 1.05],
    ...
    Result = parallel_basepoints(param_samples, Next_Conditions, n_jobs=256, save_path=Save_path)
