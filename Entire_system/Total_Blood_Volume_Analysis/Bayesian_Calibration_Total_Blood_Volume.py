...
subset_vars = {'a2', 'ahead1', 'beta2', 'C2', 'C_O2_param1', 'Cvam_O2_n', 'E_rs', 'Emax_la', 'Emax_lv0', 'Emax_rv0',
...
"Max LA Pressure Mitral Opening": (12.0, 9.0), "LA Contraction Volume diff": (0.0, 0.0), "RA Contraction Volume diff": (0.0, 0.0),
...
if __name__ == "__main__":
    ...
    np.save(f"NROY_Points_rest_{percent}_V_tot.npy", nroy_points)
    np.save(f"NROY_Params_rest_{percent}_V_tot.npy", params_post_hm)
    np.save(f"NROY_Implaus_rest_{percent}_V_tot.npy", impl_scores)
    np.save(f"test_param_rest_{percent}_V_tot.npy", test_parameters)
