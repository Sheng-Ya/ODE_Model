...
Expects in HM run directory:
  NROY_Points_exercise_{PERCENT}_constant.npy  -- NROY parameter vectors
  NROY_Params_exercise_{PERCENT}_constant.npy  -- NROY bounds dict
...
nroy_params_dict = np.load(
    os.path.join(root, f"NROY_Params_exercise_{PERCENT}_constant.npy"), allow_pickle=True # change
).item()
