...
# Exercise
subset_vars = {'alpha2', 'beta2', 'C_amv', 'C_bv', 'C_ev', 'C_O2_param3', 'C_pa', 'C_pp', 'C_pv', 'C_rmv', 'C_sa',
...
if __name__ == "__main__":
    ...
    pre_wave_simulations = env_int("HM_PRE_WAVE_SIMULATIONS", 8192)
    ...
    np.save(os.path.join(hm_run_dir, f"NROY_Points_exercise_{percent}_constant.npy"), nroy_points)
    np.save(os.path.join(hm_run_dir, f"NROY_Params_exercise_{percent}_constant.npy"), params_post_hm)
    np.save(os.path.join(hm_run_dir, f"NROY_Implaus_exercise_{percent}_constant.npy"), impl_scores)
    np.save(os.path.join(hm_run_dir, f"test_param_exercise_{percent}_constant.npy"), test_parameters)
