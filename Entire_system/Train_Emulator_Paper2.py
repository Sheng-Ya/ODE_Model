...
# union of all sensitive parameters of all targets but the input into the emulator is only
# the sensitive parameters of that target with the rest of the values at its nominal value
...
if __name__ == "__main__":
    ...
    MODEL_NAME = "GaussianProcessMatern52"
    N_SAMPLES = 1000
    N_JOBS = 250
    TRAIN_SIZE_CAP = 1000
    ...
    # =========================
    # 3) Train samples for emulators (all 68 perturbed)
    # =========================
    subset_vars = {'C2', 'C_jp', 'C_O2_param1', 'C_pa', 'C_sa', 'C_sv', 'Cvam_O2_n', 'Cvb_O2_n', 'Cvrm_O2_n', 'E_rs',
                   ...
                   'fes_o', 'fev_inf', 'fev_o', 'GT_s', 'GT_v', 'Io_met', 'Io_sv', 'k_ab', 'kcc_sv', 'KcCO2', 'KE_la',
                   'KE_lv', 'KE_ra', 'KE_rv', 'kes', 'kmet', 'l', 'MO2_bp', 'P0_la', 'P0_lv', 'P0_rv', 'P_n', 'PaCO2_n',
                   'r', 'R_bpn', 'R_pa', 'R_po', 'R_pp', 'R_rs', 'R_sa', 'rise_time_atr', 'rise_time_ven', 'T0',
                   'theta_svn', 'V0_dead', 'V_nominal', 'V_scale', 'VA_rest', 'Vu_amv0', 'Vu_bv', 'Vu_ev0', 'Vu_jp',
                   'Vu_la', 'Vu_lv', 'Vu_ra', 'Vu_rv', 'Vu_sv0', 'Wb_sh', 'Wb_sp', 'Wb_sv'}
    # subset_vars = ('a2', 'C2', 'C_jp', 'C_O2_param1', 'C_pa', 'C_pv', 'C_sa', 'C_sv', 'Cvam_O2_n', 'Cvb_O2_n',
    #                'Cvrm_O2_n', 'E_rs', 'Emax_la', 'Emax_lv0', 'Emax_rv0', 'f_ab_max', 'fab_o', 'fall_time_ven',
    #                'fes_inf', 'fes_min', 'fes_o', 'fev_inf', 'fev_o', 'G_ap', 'GEmax_lv', 'GT_s', 'GT_v', 'GV_dead',
    #                'GV_sv', 'Io_met', 'Io_sv', 'K2', 'k_ab', 'kcc_sv', 'KcCO2', 'KE_la', 'KE_lv', 'KE_ra', 'KE_rv',
    #                'kes', 'kmet', 'Kv_mi', 'l', 'MO2_bp', 'P0_la', 'P0_lv', 'P0_ra', 'P0_rv', 'P_n', 'PaCO2_n', 'r',
    #                'R_bpn', 'R_pa', 'R_po', 'R_pp', 'R_rs', 'R_sa', 'R_sp0', 'rise_time_atr', 'rise_time_ven',
    #                'scale_param4', 'T0', 'theta_spn', 'theta_svn', 'V0_dead', 'V_nominal', 'V_scale', 'VA_rest',
    #                'Vu_amv0', 'Vu_bv', 'Vu_ev0', 'Vu_jp', 'Vu_la', 'Vu_lv', 'Vu_ra', 'Vu_rmv0', 'Vu_rv', 'Vu_sv0',
    #                'Wb_sh', 'Wb_sp', 'Wb_sv')
    ...
    # np.save(f"LHCS_1000_X_03_90.npy", X)
    #
    ...
    # np.save(f"LHCS_1000_Result_03_90.npy", Result)
    X = np.load(f'LHCS_1000_X.npy')
    Result = np.load('LHCS_1000_Result.npy')

    # X = np.load(f'LHCS_1000_X_03_90.npy')
    # Result = np.load('LHCS_1000_Result_03_90.npy')
    ...
    for j, target_name in enumerate(output_names_full):
        ...
        feature_mask = np.ptp(X_target, axis=0) != 0
        X_train = X_target[:, feature_mask]
