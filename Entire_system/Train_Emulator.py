...
X_all = np.load('Max_RA_P_LHCS_500000_X_sample_rest.npy')[:135000]
...
# HR
# idx_30000 = np.random.choice(len(Result), size=30000, replace=False)
# X_30000 = X[idx_30000,:]
# Result_30000 = Result[idx_30000]
...
# EMULATION
# "GaussianProcessCorrelated" does not work
model_names = ["rbf", "LightGBM", "SupportVectorMachine", "RandomForest", "MLP", "EnsembleMLP", "EnsembleMLPDropout",
"GaussianProcess", "GaussianProcessMatern32", "GaussianProcessMatern52", "GaussianProcessRBF"]
...
for model_name in model_names:
    ...
    joblib.dump(best, f"best_{model_name}/Max_RA_{model_name}_10000.joblib")

    fig = ae.plot(best, fname=f"Max_RA_{model_name}_10000.png")
