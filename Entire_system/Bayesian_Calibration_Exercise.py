...
# Exercise
subset_vars = {'a2', 'ahead1', 'alpha2', 'beta2', 'C2', 'C_amv', 'C_bv', 'C_ev', 'C_jp', 'C_O2_param1', 'C_pa', 'C_pp',
...
# rest
subset_overlap = {'a2', 'ahead1', 'beta2', 'C2', 'C_jp', 'C_O2_param1', 'C_sv', 'Cvam_O2_n', 'E_rs', 'Emax_la',
...
if __name__ == "__main__":
    ...
    # A = np.load(r"C:\Users\vanes\Downloads\exercise_model\ODE_Exercise\Entire_system\MCMC_Old_Attempts\MCMC_HPC_Low_RA\MCMC_Rest_20_05_05_1500_logspline_copula_prior\refined_map_sample.npy")
