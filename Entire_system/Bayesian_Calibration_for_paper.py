...
# change
# # No P_thor: 53 parameters contribute at least 2% and up to 90% sensitivity for 21 targets
...
subset_vars = {'C2', 'C_jp', 'C_O2_param1', 'C_pa', 'C_sa', 'C_sv', 'Cvam_O2_n', 'Cvb_O2_n', 'Cvrm_O2_n', 'E_rs',
               'Emax_la', 'Emax_lv0', 'Emax_rv0', 'f_ab_max', 'fab_o', 'fall_time_ven', 'fes_inf', 'fes_min', 'fes_o',
               ...
               'V0_dead', 'V_nominal', 'V_scale', 'VA_rest', 'Vu_amv0', 'Vu_bv', 'Vu_ev0', 'Vu_jp', 'Vu_la', 'Vu_lv',
