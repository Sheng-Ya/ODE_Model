...
With_Simulation.py -> Run_model_Paper.py). Everything stays inside
DGSM_Union_Paper_Final_50:
...
All outputs land in <run_dir>/Target_Trace. Nothing outside
DGSM_Union_Paper_Final_50 is imported or called.
"""
...
def import_plot_module() -> Any:
    ...
    It lives in this HM_MCMC folder (inside DGSM_Union_Paper_Final_50), so using
    it does not reach outside the project tree. Reusing it guarantees the refined
