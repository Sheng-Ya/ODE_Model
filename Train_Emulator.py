...
X = np.load('C:/Users/vanes/Downloads/exercise_model/ODE_Exercise/Entire system/X_samples_PACO2.npy')
two_Result = np.load('C:/Users/vanes/Downloads/exercise_model/ODE_Exercise/Entire system/Result_PO2.npy')

Result = two_Result[:, 1]
#
# X1 = np.load('X_samples_PaCO2_1000.npy')
# Result1 = np.load('Result_PaCO2_1000.npy')
...
gp = ae.get_model("RadialBasisFunctions")
# ae.evaluate(RB)
ae.evaluate(gp)
#
...
# ae.save(rb_final, "best_emulator_PaCO2_fixed")
# ae.save(gp_final, "best_emulator_PaCO2_fixed1")
...
sp.heatmap("PaCO2", "ST", "Total Order Sensitivity", ax1)
sp.heatmap("PaCO2", "S1", "First Order Sensitivity", ax2)
plt.show()
...
sp.heatmap("PaCO2", "ST", "Total Order", ax=ax1)
sp.heatmap("PaCO2", "ST_conf", "Total Order Conf.", ax=ax2)
sp.heatmap("PaCO2", "S1", "First Order", ax=ax3)
sp.heatmap("PaCO2", "S1_conf", "First Order Conf.", ax=ax4)
plt.show()