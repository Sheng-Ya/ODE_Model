...
parameters = {
    ...
    "R_rs": (3.02 * lower, 3.02 * upper),

    "A0_ua": (1 * lower, 1 * upper),
    "C_ua": (0.001 * lower, 0.001 * upper),
    "K_ua": (1 * lower, 1 * upper),
    "Pcrit_min": (-40 * upper, -40 * lower),
    "R_CW": (0.8326 * lower, 0.8326 * upper),
    "R_trachea": (1000000 * lower, 1000000 * upper),
